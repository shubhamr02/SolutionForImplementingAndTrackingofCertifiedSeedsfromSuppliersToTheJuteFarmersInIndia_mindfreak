...
<html lang="en">
<head>
	<title>Inspection Officer Details</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Farmer Name is required">
						<input class="input100" type="text" name="fname"  placeholder="Ravi Kumar" required>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Contact Number is required">
						<input class="input100" type="text" name="contact"  placeholder="9988776655" required>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Seed Bag Number
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Bag Number is required">
						<input class="input100" type="text" name="bag"  placeholder="12345" required>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Seed Lot Number
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Lot Number is required">
						<input class="input100" type="text" name="lot"  placeholder="4445" required>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						City
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "City is required">
						<input class="input100" type="text" name="city"  placeholder="Mumbai" required>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						State
                ...
                <select class="input100">
				  ...
				  <option value="8">Andra Pradesh</option>
                </select>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Address is required">
						<input class="input100" type="textarea" name="address"  placeholder="Gandhi Marg-301" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Pincode is required">
						<input class="input100" type="text" name="pincode"  placeholder="400 809" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Aadhaar Number is required">
						<input class="input100" type="text" name="aadhar"  placeholder="0000 1111 2222" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Inspection Officer Name is required">
						<input class="input100" type="text" name="iname"  placeholder="Mandaar Deshmukh" required>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Inspection Officer Contact 
					</span>
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Contact Number is required">
						<input class="input100" type="text" name="icontact"  placeholder="9988776655" required>
						<span class="focus-input100"></span>
					</div>

					
					
					<div class="wrap-input100 validate-input m-b-12" data-validate = "Image1 is required">
					<label for="upload-photo"> </label>
					<input type="file" class="input100" name="myfile" id="myfile"accept="image/png, image/jpeg/>
					<span class="focus-input100"></span>
					</div>
				<div class="wrap-input100 validate-input m-b-12" data-validate = "Image2 is required">
					<label for="upload-photo"> </label>
					<input type="file" class="input100" name="myfile" id="myfile" accept="image/png, image/jpeg/>
					<span class="focus-input100"></span>
					</div>
				<div class="wrap-input100 validate-input m-b-12" data-validate = "Image3 is required">
					<label for="upload-photo"> </label>
					<input type="file" class="input100" name="myfile" id="myfile" accept="image/png, image/jpeg/>
					<span class="focus-input100"></span>
					</div>
				<div class="wrap-input100 validate-input m-b-12" data-validate = "Image4 is required">
					<label for="upload-photo"> </label>
					<input type="file" class="input100" name="myfile" id="myfile" accept="image/png, image/jpeg/>
					<span class="focus-input100"></span>
					</div>
