...
if(isset($_POST['submit']))
{
  date_default_timezone_set('Asia/Kolkata');
    ...
    if ($conn->query($result) === TRUE) 
      {
          header("Location: viewinvt_s.php");
        }
     else 
      {
...
$result5 = mysqli_query($conn,"SELECT ssid,seed,seedtype,lot,germination,purity,bag,qty FROM seeds group by seedtype");
                            ...
                            <div class="form-group col-sm-4" style="font-size: large; ">
                                                  &nbsp;&nbsp; &nbsp;&nbsp;    <label>Seed Type:</label>
                                                       ...
                                                       <?php
                                                        ...
                                                        ?>
                                                       <option value="<?php echo($row5['seedtype']); ?>"><?php echo($row5['seedtype']); ?></option>
